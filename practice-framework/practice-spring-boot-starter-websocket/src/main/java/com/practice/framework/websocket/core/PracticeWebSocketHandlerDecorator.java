package com.practice.framework.websocket.core;
...
public class PracticeWebSocketHandlerDecorator extends WebSocketHandlerDecorator {
    public PracticeWebSocketHandlerDecorator(WebSocketHandler delegate) {
        super(delegate);
    }
