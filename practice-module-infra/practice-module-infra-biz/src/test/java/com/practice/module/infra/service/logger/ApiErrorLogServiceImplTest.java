package com.practice.module.infra.service.logger;
...
import com.practice.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogExportReqVO;
import com.practice.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.practice.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.practice.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.practice.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.practice.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.practice.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("practice-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("practice-test");
