package com.practice.module.infra.service.codegen.inner;
...
import com.practice.framework.common.util.date.LocalDateTimeUtils;
...
import com.practice.framework.operatelog.core.enums.OperateTypeEnum;
...
import com.practice.module.infra.enums.codegen.CodegenFrontTypeEnum;
import com.practice.module.infra.enums.codegen.CodegenSceneEnum;
import com.practice.module.infra.framework.codegen.config.CodegenProperties;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "practice-module-${table.moduleName}/" + // 顶级模块
                "practice-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "practice-module-${table.moduleName}/" + // 顶级模块
                "practice-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "practice-ui-${sceneEnum.basePackage}/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "practice-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
