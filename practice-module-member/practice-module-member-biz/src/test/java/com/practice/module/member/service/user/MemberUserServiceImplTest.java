package com.practice.module.member.service.user;
...
import com.practice.module.member.controller.app.user.vo.AppUserUpdateMobileReqVO;
...
import com.practice.module.member.service.auth.MemberAuthServiceImpl;
 ...
 * @author 宋天
 */
@Import({MemberUserServiceImpl.class, PracticeRedisAutoConfiguration.class})
