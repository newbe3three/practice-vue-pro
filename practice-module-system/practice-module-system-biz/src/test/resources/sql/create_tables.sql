...
-- 将该建表 SQL 语句，添加到 practice-module-system-biz 模块的 test/resources/sql/create_tables.sql 文件里
...
CREATE TABLE IF NOT EXISTS "system_task_apply" (
                                                   "id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
                                                   "name" varchar NOT NULL,
                                                   "dept_name" varchar NOT NULL,
                                                   "creator" varchar DEFAULT '',
...
CREATE TABLE IF NOT EXISTS "system_resource_article" (
                                                         "id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
                                                         "user_id" bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS "system_practice" (
                                                 "id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
                                                 "name" varchar NOT NULL,
                                                 "content" varchar NOT NULL,
                                                 "start_time" varchar NOT NULL,
...
CREATE TABLE IF NOT EXISTS "system_practice_apply" (
                                                       "id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
                                                       "user_id" bigint,
...
CREATE TABLE IF NOT EXISTS "system_practice_school" (
                                                        "id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
                                                        "school_id" bigint,
...
CREATE TABLE IF NOT EXISTS "system_students" (
                                                 "id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
                                                 "user_id" bigint,
                                                 "name" varchar NOT NULL,
                                                 "dept_id" bigint,
...
CREATE TABLE IF NOT EXISTS "system_organization_company" (
                                                             "id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
                                                             "name" varchar NOT NULL,
                                                             ...
                                                             "principal_sex" varchar,
                                                             "principal_wechat" varchar,
                                                             "principal_position" varchar,
                                                             "code" varchar NOT NULL,
...
CREATE TABLE IF NOT EXISTS "system_organization_school" (
...
CREATE TABLE IF NOT EXISTS "system_organization_other" (
                                                           "id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
                                                           "name" varchar NOT NULL,
                                                           "abbreviation" varchar,
                                                           "ref" varchar,
...
CREATE TABLE IF NOT EXISTS "system_user_skill" (
                                                   "id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
                                                   "user_id" bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS "system_user_work" (
                                                  "id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
                                                  "user_id" bigint NOT NULL,
                                                  "name" varchar NOT NULL,
                                                  "type" varchar NOT NULL,
...
CREATE TABLE IF NOT EXISTS "system_sign_in" (
                                                "id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
                                                "user_id" bigint,
                                                "practice_id" bigint NOT NULL,
                                                "status" varchar,
                                                ...
                                                "sign_in_time" varchar NOT NULL,
                                                "sign_out_time" varchar NOT NULL,
                                                "sign_in_location" varchar NOT NULL,
                                                "sign_out_location" varchar NOT NULL,
                                                "creator" varchar DEFAULT '',
                                                "updater" varchar DEFAULT '',
                                                "create_time" datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
                                                "update_time" datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS "system_work_log" (
                                                 "id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
                                                 "user_id" bigint NOT NULL,
                                                 "practice_id" bigint NOT NULL,
                                                 "finish_task" varchar NOT NULL,
                                                 "todo_task" varchar NOT NULL,
                                                 "to_discuss_task" varchar NOT NULL,
                                                 "creator" varchar DEFAULT '',
                                                 "updater" varchar DEFAULT '',
                                                 "create_time" datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
                                                 "update_time" datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
