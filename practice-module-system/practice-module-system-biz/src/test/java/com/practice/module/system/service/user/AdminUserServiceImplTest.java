...
import com.practice.framework.common.util.collection.ArrayUtils;
...
import com.practice.module.infra.api.file.FileApi;
import com.practice.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.practice.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
...
import com.practice.module.system.dal.dataobject.dept.PostDO;
...
import com.practice.module.system.dal.mysql.dept.UserPostMapper;
...
import com.practice.module.system.service.dept.PostService;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("practiceyuanma");
        ...
        assertEquals("practiceyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("practiceyuanma"))).thenReturn("java");
