package com.practice.module.system.controller.admin.user.vo.user;
...
public class UserPageReqVO extends PageParam {
    ...
    @Schema(description = "用户账号,模糊匹配", example = "practice")
    private String username;

    @Schema(description = "手机号码,模糊匹配", example = "practice")
