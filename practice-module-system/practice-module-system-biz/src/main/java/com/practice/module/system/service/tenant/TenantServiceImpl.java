...
import com.practice.framework.common.util.date.DateUtils;
...
import com.practice.module.system.controller.admin.permission.vo.role.RoleCreateReqVO;
...
import com.practice.module.system.convert.tenant.TenantConvert;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 practice.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
