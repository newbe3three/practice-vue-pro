      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template v-slot="scope">
          <el-button size="mini" type="text" icon="el-icon-edit" @click="handleUpdate(scope.row)"
                     v-hasPermi="['system:organization-company:update']">修改</el-button>
...
<script>
import { createOrganizationCompany, updateOrganizationCompany, deleteOrganizationCompany, getOrganizationCompany, getOrganizationCompanyPage, exportOrganizationCompanyExcel } from "@/api/system/organizationCompany";
