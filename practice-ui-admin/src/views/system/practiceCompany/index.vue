<template>
    <div class="app-container">
        ...
        <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
            ...
            <el-form-item label="状态" prop="status">
                <el-select v-model="queryParams.status" placeholder="请选择状态" clearable size="small">
                    <el-option v-for="dict in this.getDictDatas(DICT_TYPE.PRACTICE_STATUS)" :key="dict.value"
        ...
        <el-table v-loading="loading" :data="list">
            ...
            <el-table-column label="职业要求" align="center" prop="requirement" />
        ...
        <el-dialog :title="title" :visible.sync="open" width="500px" v-dialogDrag append-to-body>
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                ...
                <el-form-item label="结束时间" prop="endTime">
                    <el-date-picker clearable v-model="form.endTime" type="date" value-format="timestamp"
                        placeholder="选择结束时间" />
                </el-form-item>
...
export default {
    ...
    data() {
        return {
            ...
            rules: {
                ...
                requirement: [{ required: true, message: "实践要求不能为空", trigger: "blur" }],
    ...
    methods: {
        ...
        getList() {
            this.loading = true;
            // 执行查询
            this.queryParams.companyId = getTenantId();
            console.log("123", getTenantId());
            companyGetPracticePage(this.queryParams).then(response => {
        ...
        submitForm() {
            this.$refs["form"].validate(valid => {
                ...
                // 添加的提交
                companyCreatePractice(this.form).then(response => {
