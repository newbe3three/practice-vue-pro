package com.practice.module.promotion.service.price;
...
import com.practice.module.promotion.api.price.dto.CouponMeetRespDTO;
...
import com.practice.module.promotion.convert.price.PriceConvert;
...
import com.practice.module.promotion.enums.common.*;
import com.practice.module.promotion.enums.coupon.CouponStatusEnum;
import com.practice.module.promotion.service.coupon.CouponService;
import com.practice.module.promotion.service.discount.DiscountActivityService;
import com.practice.module.promotion.service.discount.bo.DiscountProductDetailBO;
import com.practice.module.promotion.service.reward.RewardActivityService;
...
import static com.practice.framework.common.util.collection.CollectionUtils.getSumValue;
import static com.practice.module.product.enums.ErrorCodeConstants.SKU_NOT_EXISTS;
...
//                            .setMeetTip(String.format("差 %s 元可用优惠劵", formatPrice(coupon.getUsePrice() - originPrice)));
     ...
     * 计算商品级别的价格，例如说：
     * 1. 会员折扣
     * 2. 限时折扣 {@link com.practice.module.promotion.dal.dataobject.discount.DiscountActivityDO}
     *
     * 其中，会员折扣、限时折扣取最低价
     *
     * @param userId 用户编号
    ...
    /**
     * 计算订单级别的价格，例如说：
     * 1. 满减送 {@link com.practice.module.promotion.dal.dataobject.reward.RewardActivityDO}
     *
     * @param userId 用户编号
     * @param priceCalculate 价格计算的结果
     */
