...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.practice";
    private static final String ARTIFACT_ID = "practice";
    private static final String PACKAGE_NAME = "com.practice";
    private static final String TITLE = "练习管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.practice";
        String artifactIdNew = "practice";
        String packageNameNew = "com.practice";
        String titleNew = "练习管理系统";
