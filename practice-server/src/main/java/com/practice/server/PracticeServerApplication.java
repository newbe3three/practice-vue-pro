 ...
 * @author 芋道源码
 */
@SuppressWarnings("SpringComponentScan") // 忽略 IDEA 无法识别 ${practice.info.base-package}
@SpringBootApplication(scanBasePackages = {"${practice.info.base-package}.server", "${practice.info.base-package}.module"})
